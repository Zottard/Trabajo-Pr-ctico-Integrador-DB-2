...
horario TIME NOT NULL CHECK(horario>'10:00:00' AND horario<'20:00:00'),
fecha DATE NOT NULL CHECK (fecha > GETDATE()),
precio_base DECIMAL(5,2) NOT NULL CHECK(precio_base >0),
...
descuento_aplicado DECIMAL(5,2) DEFAULT 0.0 CHECK(descuento_aplicado<1),
...
monto_descuento INT NOT NULL DEFAULT 0.0,
