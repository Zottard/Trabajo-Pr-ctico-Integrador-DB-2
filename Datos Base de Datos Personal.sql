...
INSERT INTO Reservas (
    ...
    1, 
    (SELECT id FROM Personas WHERE dni = '20345678'), 
    3, 
    1, 
    10000.00, 
    0.00,     
...
INSERT INTO Reservas (
    ...
    1, 
    (SELECT id FROM Personas WHERE dni = '25456789'), 
    3, 
    1, 
    10000.00,
    0.00,
...
INSERT INTO Reservas (
    ...
    1, 
    (SELECT id FROM Personas WHERE dni = '48567890'), 
    2,
    1,
    5000.00, 
    0.00,
...
INSERT INTO Reservas (
    ...
    1, 
    (SELECT id FROM Personas WHERE dni = '52678901'), 
    1, 
    1, 
    0.00,
    0.00,
...
INSERT INTO Reservas (
    ...
    2, 
    (SELECT id FROM Personas WHERE dni = '12123456'), 
    4, 
    3, 
    8400.00, 
    1260.00, 
...
INSERT INTO Reservas (
    ...
    3, 
    (SELECT id FROM Personas WHERE dni = '30456789'),
    3,
    5, 
    8000.00,
    0.00,
...
INSERT INTO Reservas (
    ...
    19, 
    (SELECT id FROM Personas WHERE dni = '32567890'),
    3,
    2, 
    15000.00, 
    1500.00, 
...
(7, (SELECT id FROM Personas WHERE dni = '18789012'), 3, 1, 10000.00, 2000.00, 8000.00, 'Confirmada'),
(7, (SELECT id FROM Personas WHERE dni = '22890123'), 3, 1, 10000.00, 2000.00, 8000.00, 'Confirmada'),
(7, (SELECT id FROM Personas WHERE dni = '46901234'), 2, 1, 5000.00, 1000.00, 4000.00, 'Confirmada'),
(7, (SELECT id FROM Personas WHERE dni = '49012345'), 2, 1, 5000.00, 1000.00, 4000.00, 'Confirmada');
...
INSERT INTO Reservas (
    ...
    6, 
    (SELECT id FROM Personas WHERE dni = '35678901'), 
    3,
    4, 
    15000.00,
    0.00,
